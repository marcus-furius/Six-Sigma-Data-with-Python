...
spacex_df = pd.read_csv("course\Data Science Keystone\spacex_launch_dash.csv")
...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.RangeSlider(
                                    ...
                                    max=10000,
                                    step=1000,
                                    marks={i: f'{i}' for i in range(0, 11000, 2500)},  # Add marks for better visualization
...
# Callback function for `site-dropdown` and `payload-slider` inputs, and `success-payload-scatter-chart` output
@app.callback(
